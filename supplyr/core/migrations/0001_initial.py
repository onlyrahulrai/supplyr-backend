    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_category', models.IntegerField(blank=True, choices=[(1, 'Manufacturer'), (2, 'Distributer'), (3, 'Wholeseller')], null=True)),
                ('entity_type', models.CharField(blank=True, choices=[('pvtltd', 'Private Limited'), ('llp', 'Limited Liablity Partnership'), ('part', 'Partnership'), ('prop', 'Propertieship')], max_length=15, null=True)),
